        ...
        <div class="overlay c-overlay cover" style="background: linear-gradient(to right, #62559b,#149896);">
          ...
          <div class="container" style="padding-top: 0px;width: fit-content;">
            ...
            <div align="center" style="margin-top: 70px">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12"> <form action="register.php">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 guide">
                    ...
                    <li class="subodd">The anti-plagiarism policy is applicable to all submissions. Only the author(s) is responsible for any plagiarized submission. The similarity index for a submitted paper should be below 10%.</li>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                     <div class="card-container">
                        <div class="card">
                            ...
                            <div class="back">
                                <li class="domain-list navbar-fixed-top" style="background-color: #2980b9;text-align: center;color: white"><h4>Civil Engineering</h4></li>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card-container">
                        <div class="card">
                            ...
                            <div class="back">
                                <li class="domain-list navbar-fixed-top" style="background-color: #2980b9;text-align: center;color: white"><h4>Elec. &amp; Tele. Engineering</h4> </li>
                         ...
                         <div class="card-container">
                            <div class="card">
                                ...
                                <img src="images/CGIP.png" style="width:150px;margin-bottom: 50px;">
                                        <h3 class="call-head">COMPS &amp; IT Engineering</h3>
                                    </div>
                                ...
                                <div class="back" style="width:auto;">
                                    <li class="domain-list navbar-fixed-top" style="background-color: #2980b9;text-align: center;color: white"> <h4>COMPS &amp; IT Engineering</h4></li>
                            ...
                            <div class="card">
                                <div class="front" style="display: flex; align-items: center;justify-content: center;">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h3 class="call-head">Humanities &amp; Applied Science</h3>
                                    </div>
                                ...
                                <div class="back">
                                    <li class="domain-list navbar-fixed-top" style="background-color: #2980b9;text-align: center;color: white"><h4>Humanities &amp; Applied Science</h4></li>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                         <div class="card-container">
                            <div class="card">
                                ...
                                <div class="back">
                                    <li class="domain-list navbar-fixed-top" style="background-color: #2980b9;text-align: center;color: white"><h4>Mechanical Engineering</h4></li>
                                    <ul id="civil" class="domain-list-tab" style="background-color: white;padding: 10px;overflow-y:scroll;height:340px;margin-top: 50px;margin-bottom: 0px;"> 
 ...
 <!--Team Information-->
    <section id="teaminfo" style="background-color: white;">
        <div class="container-fluid" style="padding: 0px;">
            ...
            <div class="row">
                <div class="col-lg-3" style="display: block;margin-top:50px;text-align: center">
                    <img src="images/image.png" class=" comittee-head">
                    <h4 style="margin-top: 20px">Shri Chiragbhai Shah</h4>
                    <h5 style="margin-top: 10px">Honorable Chairman</h5>
                </div>
                <div class="col-lg-3" style="display: block;margin-top:50px;text-align: center">
                    <img src="images/image.png" class=" comittee-head">
                    <h4 style="margin-top: 20px">Dr. U. D. Kolekar</h4>
                    <h5 style="margin-top: 10px">Principal</h5>
                </div>
                <div class="col-lg-3" style="display: block;margin-top:50px;text-align: center">
                    <img src="images/image.png" class=" comittee-head">
                    <h4 style="margin-top: 20px">Prof. A. M. Deshpande</h4>
                    <h5 style="margin-top: 10px"><!--Vice - Principal-->Dean Academics</h5>
                </div>
                <div class="col-lg-3" style="display: block;margin-top:50px;text-align: center">
                    <img src="images/image.png" class=" comittee-head">
                    <h4 style="margin-top: 20px">Prof. S. S. Nanivadekar</h4>
                    <h5 style="margin-top: 10px">Dean Administration</h5>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                                ...
                                <div class="com-nal-org com-info">BATU</div>
                            </div>
                            <div class="col-lg-4 com-padding">
                               <div class="com-nal-name com-info">Dr. Udhav Bhosale</div>
                                <div class="com-nal-org com-info">Rajiv Gandhi</div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                                <div class="com-nal-name com-info">Dr. Sirsagar</div>
                            ...
                            <div class="col-lg-4 com-padding">
                               <div class="com-nal-name com-info">Dr. Sanjay Kherde</div>
                                <div class="com-nal-org com-info">KGCE Amravati</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 com-padding">
                               <div class="com-nal-name com-info">Prof. Sandip Bhale</div>
                                <div class="com-nal-org com-info">Organization</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="row com">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                                <div class="com-tech-name com-info">Dr. Kivlekar</div>
                                <div class="com-tech-org com-info">BATU</div>
                            </div>
                            <div class="col-lg-4 com-padding">
                               <div class="com-tech-name com-info">Dr. B R Patil</div>
                                <div class="com-tech-org com-info">Vishawaniketan College</div>
                            </div>
                       
                            <div class="col-lg-4 com-padding">
                               <div class="com-tech-name com-info">Dr. R.B. Ghongade</div>
                                <div class="com-tech-org com-info">Bhartiya Vidyapeeth</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                                <div class="com-tech-name com-info">Dr. Khandpekar</div>
                                <div class="com-tech-org com-info">Birla College</div>
                            </div>
                            <div class="col-lg-4 com-padding">
                               <div class="com-tech-name com-info">Dr. Madhukar Langre</div>
                                <div class="com-tech-org com-info">Kokan Gyanpeeth</div>
                            </div>
                       
                            <div class="col-lg-4 com-padding">
                               <div class="com-tech-name com-info">Dr. Rashmi Chaughale</div>
                                <div class="com-tech-org com-info">S G Godhavat Kolhapur</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                        ...
                        <div class="row">
                            <div class="col-lg-4 com-padding">
                                <div class="com-tech-name com-info">Mr. Sachin Chawan</div>
                                <div class="com-tech-org com-info">ONGC</div>
                            </div>
                            <div class="col-lg-4 com-padding">
                            ...
                            <div class="col-lg-4 com-padding">
                               <div class="com-tech-name com-info">Mrs. Sandhya Pandey</div>
                                <div class="com-tech-org com-info">Industrialist</div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="row com">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-4 com-padding">
                               <div class="com-org-name com-info">Prof. S. L. Shelgaonkar</div>
                                <div class="com-org-org com-info">Organizing Chair</div>
                            </div>                       
...
<!--Footer-->
 ...
 <!--         		 <br><br>
                ...
                <br> <br> <br>-->
<div class="text-center"><h5><span>Designed and Developed By <a href="webteam.php">WEBTEAM</a></span></h5></div>
